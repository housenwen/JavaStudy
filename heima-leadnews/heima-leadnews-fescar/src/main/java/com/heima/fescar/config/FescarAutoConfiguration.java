package com.heima.fescar.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.fescar.rm.datasource.DataSourceProxy;
import com.alibaba.fescar.spring.annotation.GlobalTransactionScanner;
import com.heima.fescar.filter.FescarRMRequestFilter;
import com.heima.fescar.interceptor.FescarRestInterceptor;
...
public class FescarAutoConfiguration {
    ...
    @Bean
    @Primary
    public DataSourceProxy druidDataSource(Environment environment){
