...
public class test {
    public static void main(String[] args) throws Exception{
        ...
        //todo 5.执行sql:boolean execute() 在此 PreparedStatement 对象中执行 SQL 语句，该语句可以是任何种类的 SQL 语句。
        cst.execute();
        /**
